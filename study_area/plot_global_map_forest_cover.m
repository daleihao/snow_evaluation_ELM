function plot_global_map_elevation(lats, lons, sw_total, min_clr, max_clr, title_text, isxticklabel, isyticklabel,num_label)
axis equal
...
% 
% m_scatter(siteData(~filters,7),siteData(~filters,6),4,[0.4 0.4 0.4],'filled')
