...
load('../../../../data_processing/swe_daily_3000.mat');
Rs_1 = nan(144,168,2);
Rs_2 = nan(144,168,2);
Rs_3 = nan(144,168,2);
for season_i = 1:2
    for row_i = 1:144
        for col_j = 1:168
            ...
            tmp1 = squeeze(ELM_swes(row_i, col_j,filter_day));
            tmp2 = squeeze(UA_swes(row_i, col_j,filter_day));
            tmp3 = squeeze(SNODAS_swes(row_i, col_j,filter_day));
...
save('swe_temporal_R.mat','Rs_1','Rs_2','Rs_3');