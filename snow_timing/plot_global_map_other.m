function plot_global_map_other(lats, lons, sw_total, min_clr, max_clr, seq_text, isyticklabel, isxticklabel)
axis equal
...
hold on
    ...
    xticks = [-125:5:-105];
    xtick_labels = ['-125';'-120';'-115';'-110';'-105'];
...
elseif ~isyticklabel && isxticklabel
    ...
    m_grid('tickdir','out','linestyle','none','backcolor',[.9 .99 1], 'xticklabels',[], 'yticklabels',[], ...
        'fontsize',8,'tickstyle','dd','yticklabel',[]...
        );
end
