...
title("SOnDt",'fontsize',10, 'fontweight', 'bold')
...
title("SMOnDt",'fontsize',10, 'fontweight', 'bold')
...
title("SMMidDt",'fontsize',10, 'fontweight', 'bold')
...
title("SEnDt",'fontsize',10, 'fontweight', 'bold')
...
title("SDurDy",'fontsize',10, 'fontweight', 'bold')
