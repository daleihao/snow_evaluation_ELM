...
for year_i = 2001:2019
    ...
    filters = ELM_end_of_snow_num<18 | isUS<1 | MODSCAG_end_of_snow_num<18 | SPIRES_end_of_snow_num<18 | MODSCAG_midpoint_of_snow_num<18 | SPIRES_midpoint_of_snow_num<18;
    ELM_tmp(filters) = nan;
    MODSCAG_tmp(filters) = nan;
    SPIRES_tmp(filters) = nan;
