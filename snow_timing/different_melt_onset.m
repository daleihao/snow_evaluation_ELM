...
colormap(ax1, colors);
hold on
plot_global_map_other(lats, lons, melt_of_snow, min_values(1), max_values(1),"ELM",1, 1);
...
colormap(ax2, colors);
hold on
plot_global_map_other(lats, lons, melt_of_snow, min_values(2), max_values(2),"MODSCAG",0, 1);
set(gca,'fontsize',8,'fontname','time new roman')
...
colormap(ax3, colors);
hold on
plot_global_map_other(lats, lons, melt_of_snow, min_values(3), max_values(3),"SPIReS",0, 1);
set(gca,'fontsize',8,'fontname','time new roman')
...
print(gcf, '-dtiff', '-r300', 'different_snowmelt_onset_date.tif')
