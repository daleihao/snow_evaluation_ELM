function h = daboxplot2(Y,varargin)
...
if confs.flipcolors==1    
    ...
    if ~isempty(confs.legend)
        h.lg = legend(h.sc(1,:),confs.legend,'location','northwest');
        h.lg.Position(2) = h.lg.Position(2) +(-0.05);
    ...
    if ~isempty(confs.legend)
        h.lg = legend(h.bx(1,:),confs.legend,'location','northwest');
        h.lg.Position(2) = h.lg.Position(2) + (-0.05);
        h.lg.Position(1) = h.lg.Position(1) + 0.01;
    end
end
