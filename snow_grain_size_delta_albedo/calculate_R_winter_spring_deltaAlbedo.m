...
for season_i = 1:2
    for row_i = 1:144
        for col_j = 1:168
            ...
            tmp1 = squeeze(ELM_deltaAlbedos(row_i, col_j,filter_day));
            tmp2 = squeeze(MODSCAG_deltaAlbedos(row_i, col_j,filter_day));
            tmp3 = squeeze(SPIRES_deltaAlbedos(row_i, col_j,filter_day));
...
save('deltaalbedo_temporal_R_v2.mat','Rs_1','Rs_2','Rs_3');